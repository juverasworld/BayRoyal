...
<Nav/>
    ...
    <Title variants={conatiner} initial="hidden" animate="show">
      ...
      <motion.h2 className="lg:w-1/2 leading-normal text-[18px] w-full md:mx-5 mx-3 text-white"  variants={item} data-scroll data-scroll-delay="0.04" data-scroll-speed="2">
  	 	...
  	 	<div class="row">
  	 		...
  	 		<div class="footer-col">
  	 			...
  	 			<ul>
  	 				...
  	 				<li>Accra</li>
            <li> <a href="tel:+233 541 604 192">P:+233 541 604 192</a> </li>
  	 			</ul>
  	 		</div>
  	 		<div class="footer-col">
  	 			<h4>Nairobi</h4>
